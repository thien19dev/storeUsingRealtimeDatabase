...
public class Update_Item extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateLang = findViewById(R.id.updateLanguage);
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(Update_Item.this, "No Image Selected!", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
    ...
    public void saveData(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Update_Item.this);
    ...
    public void updateData(){
        ...
        databaseReference.setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Update_Item.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}